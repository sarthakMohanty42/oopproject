...
public class My_orders_delivery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_orders_delivery);
        ...
        FirebaseFirestore.getInstance().collection("confirmed_orders")
                .whereEqualTo("did", FirebaseAuth.getInstance().getUid())
                .get()
          ...
          //  holder.dist.setText("");
            holder.btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(My_orders_delivery.this, phoneAuthReceiver.class);
